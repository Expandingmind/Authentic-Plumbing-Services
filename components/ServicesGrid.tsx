...
export default function ServicesGrid() {
  ...
  return (
    <section id="services" className="bg-zinc-900 py-12 lg:py-16 relative overflow-hidden" ref={ref}>
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className={`lg:w-1/3 lg:sticky lg:top-24 reveal-hidden-left ${isVisible ? 'reveal-visible-x' : ''}`}>
                ...
                <Link 
                    href="#contact" 
                    className="btn-primary inline-flex bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full font-bold text-base uppercase tracking-wide shadow-lg shadow-blue-600/20 items-center gap-2"
                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {SERVICES.map((service, idx) => (
                        <Link 
                            ...
                            key={idx} 
                            className={`group relative h-[220px] overflow-hidden cursor-pointer border border-white/10 hover:border-gold/50 transition-all duration-700 block reveal-hidden ${isVisible ? 'reveal-visible' : ''}`}
